    ...
    <>
      <div className="flex flex-col">
        ...
        <div className="p-2 mt-4 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3">
          <div className="flex items-start rounded-xl bg-white p-4 shadow-2xl cursor-pointer  border border-indigo-600 hover:scale-95">
            ...
            <div className="ml-4">
              <h2 className="font-semibold">Leonidas Rubio</h2>
          ...
          <div className="flex items-start rounded-xl bg-white p-4 shadow-2xl cursor-pointer border border-indigo-600 hover:scale-95">
            ...
            <div className="ml-4">
              <h2 className="font-semibold">Normal Superior</h2>
              <p className="mt-2 text-sm text-gray-500">#CANTIDAD#</p>
            </div>
            {/* <div className="ml-4">
              <BotonSolucion />
          ...
          <div className="flex items-start rounded-xl bg-white p-4 shadow-2xl cursor-pointer border border-indigo-600 hover:scale-95">
            ...
            <div className="ml-4">
              <h2 className="font-semibold">Francisco Miranda</h2>
              <p className="mt-2 text-sm text-gray-500">#CANTIDAD#</p>
            </div>
          </div>
        </div>
